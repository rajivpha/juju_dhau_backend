                            ...
                            <div class="card-body">
                                ...
                                @endif
                                    ...
                                    <form class="form-horizontal" role="form" method="POST"
                                          action="{{ route('user.order.addorder') }}" >
                                        @csrf
                                        ...
                                        <div class="form-group row" >
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <input type="text"     name="product_name" placeholder="Product Name"
                                                       class="col-xs-10 col-sm-8" required autofocus/>
                                        ...
                                        <div class="form-group row ">
                                            <label class="col-sm-4 col-form-label text-md-right" for="quantity_size">
                                                Quantity</label>
                                            <div class="col-md-8">
                                                <input type="text"  name="quantity_size" placeholder="Quantity"
                                                       class="col-xs-10 col-sm-8" required autofocus/>
